...
async def main():
    ...
    # Create agent with debug callback and tools
    agent = Agent(
        name="debug_agent",
        model="gemini-3-flash-preview",
        instruction="You are a helpful assistant. Use the information provided above to answer questions. You have tools to perform mathematical operations.",
